...
export const alt = "张卫钰 Will Zhang — 高级全栈工程师";
...
export default function OgImage() {
  return new ImageResponse(
    ...
    >
      ...
      >
        高级全栈工程师，擅长 React、Vue、Node.js / Bun、Monorepo 工程化与 AI Agent 系统落地。
      </p>

      {/* Tags */}
      <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
        {["React", "Vue", "TypeScript", "Node.js/Bun", "Monorepo", "AI Agent"].map((tag) => (
          <div
            key={tag}
            style={{
              padding: "6px 16px",
