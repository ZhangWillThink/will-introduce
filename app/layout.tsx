...
export const metadata: Metadata = {
  ...
  title: {
    default: "张卫钰 Will Zhang — 高级全栈工程师",
    // 子页面会渲染为 "页面名 | Will Zhang"
    template: "%s | Will Zhang",
  },
  description:
    "高级全栈工程师，擅长 React、Vue、Next.js、Node.js、Bun、Monorepo 工程化与 AI Agent 系统落地。",
  keywords: [
    "高级全栈工程师",
    "React",
    "Vue",
