...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      size="icon-lg"
      onClick={(event) =>
        dispatchThemeSceneRequest('toggle', event.currentTarget)
      }
    ...
    >
      <motion.div
        ...
        transition={
          shouldReduceMotion
            ? { duration: 0 }
            : { duration: 0.24, ease: 'easeInOut' as const }
        }
      />
      ...
      <motion.div
        ...
        animate={
          shouldReduceMotion
            ...
            : { opacity: isDark ? 0.6 : 0.82, scale: isDark ? 0.96 : 1 }
        }
        transition={
          shouldReduceMotion
            ? { duration: 0 }
      ...
      >
        ...
        >
          <Sun
            ...
            className="size-[0.9rem] text-amber-500/90"
            strokeWidth={1.8}
          />
        </motion.div>
        ...
        >
          <Moon
            ...
            className="size-[0.9rem] text-sky-200/90"
            strokeWidth={1.8}
          />
        </motion.div>
      </motion.div>
