...
const skills: Skill[] = [
  ...
  { name: "Vue 3", Icon: Layers, level: 0.8, color: "violet" },
  { name: "Node.js", Icon: Server, level: 0.75, color: "emerald" },
  { name: "GSAP", Icon: Wand2, level: 0.88, color: "blue" },
  { name: "TypeScript", Icon: Braces, level: 0.9, color: "violet" },
  { name: "AI/LLM", Icon: Sparkles, level: 0.72, color: "amber" },
];

export function SkillsMatrix() {
  return (
    <TerminalWindow title="Skills" filename="skill_matrix.json" delay={0.3} className="h-full">
      <div className="p-4 sm:p-5">
        ...
        {/* Additional Info */}
        <div className="border-border/50 bg-card/30 mt-4 rounded-lg border p-3">
